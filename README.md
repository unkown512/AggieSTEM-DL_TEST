...
4) https://www.digitalocean.com/community/tutorials/how-to-install-the-apache-web-server-on-ubuntu-18-04
  b: In host config file/virtual host apache add the github name path to `/var/www/<github>/html/....`
  c: Make sure you download python 3.6.9 and redirect python to that verison.
  d: Also from step 4. Make sure mod wsgi is for python 3!
